...
local killsays = { -- found by cheese
    ...
    "clapped by marco hub user :skull:",
    "bro got clapped lol",
    ...
    "marco hub better than you smh smh smh 😅"
}
...
menu = library.new('<font color="rgb(38, 55, 189)">Marco</font>Hub on top', "novasaves\\")
local tabs = {
...
Notification:Notify(
    {Title = "Nofitication", Description = "MarcoHub Loaded in " .. tick() - t .. "s (seconds)"},
    {OutlineColor = Color3.fromRGB(80, 80, 80), Time = 5, Type = "default"}
)
